...
export const Button = styled.button`
  border-radius: 20px;
  border: 1px solid #14b080;
  background-color: #14b080;
  color: #ffffff;
  font-size: 12px;
  font-weight: bold;
  padding: 12px 45px;
...
export const Overlay = styled.div`
  background: #14b080;
  background: -webkit-linear-gradient(to right, #14b080, #14b080);
  background: linear-gradient(to right, #14b080, #14b080);
